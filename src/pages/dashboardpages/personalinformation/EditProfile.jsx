...
const EditProfile = () => {
  ...
  return (
    <div className="min-h-screen font-sans bg-gray-50">
      {/* Header */}
      <div className="bg-[#D46A6A] text-white p-4 text-xl font-semibold flex justify-between items-center rounded-md">
          ...
          <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-md space-y-6">
            ...
            <div className="flex space-x-4 pt-4">
              ...
              <Button
                ...
                className="flex-1 bg-[#D46A6A] hover:bg-[#D46A6A] text-white"
              >
                Save Changes
              </Button>
            </div>
