...
const Profile = () => {
  return (
    <div className="min-h-screen font-sans">
      {/* Header */}
      <div className="bg-[#D46A6A] hover:bg-[#D46A6A] text-white p-4 text-xl font-semibold rounded-md">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-end">
          <Link to="/dashboard/settings/changedpasswoard">
            <Button className="bg-[#D46A6A] hover:bg-[#D46A6A] text-white px-6 py-2  flex  items-center space-x-2 shadow-md ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            {/* Profile Card */}
            <div className="md:col-span-1 bg-white p-6 rounded-t-lg shadow-md flex flex-col items-center">
            ...
            <Link to="/dashboard/settings/editpersonal">
              <Button className="bg-[#D46A6A] hover:bg-[#D46A6A] text-white px-6 py-2 w-full flex  items-center space-x-2 shadow-md rounded-none rounded-b-md">
                <svg
